...
final class ProfileViewController: UIViewController, TapLikedDelegate {
  ...
  //      navigationController?.tabBarController?.tabBar.alpha = 0.9
    ...
    private func addDataSource() {
        dataSource.append(.init(author: "Ivan Ivanov", description: "Take care", image: "post1", id: "001", likes: 5, views: 5))
        dataSource.append(.init(author: "Green world", description: "What else?", image: "post2", id: "002", likes: 25, views: 50))
        dataSource.append(.init(author: "Mary Stewart", description: "What's the point?", image: "post3", id: "003", likes: 10, views: 15))
        dataSource.append(.init(author: "The Earth", description: "Be creative", image: "post4", id: "004", likes: 52, views: 60))
        dataSource.append(.init(author: "You", description: "green life", image: "post5", id: "005", likes: 30, views: 40))
    }
